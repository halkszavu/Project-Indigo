	...
	public class TransportationContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Route>().HasData(
				new Route { ID = 1, Provider = "BKK", RouteNumber = "7" },
				new Route { ID = 2, Provider = "BKK", RouteNumber = "7E" },
				new Route { ID = 3, Provider = "BKK", RouteNumber = "82" },
				new Route { ID = 4, Provider = "BKK", RouteNumber = "82A" }
				);

	...
	public class TransportationContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Stop>().HasData(
				...
				new Stop { ID = 058, Name = "Vörösmarty tér" },
				new Stop { ID = 059, Name = "Deák Ferenc tér" },
				new Stop { ID = 060, Name = "Bajcsy-Zsilinszky út" },
				new Stop { ID = 061, Name = "Opera" },
				new Stop { ID = 062, Name = "Oktogon" },
				new Stop { ID = 063, Name = "Vörösmarty utca" },
				new Stop { ID = 064, Name = "Kodály körönd" },
				new Stop { ID = 065, Name = "Bajza utca" },
				new Stop { ID = 066, Name = "Hősök tere" },
				new Stop { ID = 067, Name = "Széchenyi fürdő" },
				new Stop { ID = 068, Name = "Déli pályaudvar" },
				new Stop { ID = 069, Name = "Széll Kálmán tér" },
				new Stop { ID = 070, Name = "Batthyány tér" },
				new Stop { ID = 071, Name = "Kossuth Lajos tér" },
				new Stop { ID = 072, Name = "Puskás Ferenc Stadion" },
				new Stop { ID = 073, Name = "Pillangó utca" },
				new Stop { ID = 058, Name = "" },
				new Stop { ID = 058, Name = "" },
				new Stop { ID = 058, Name = "" },
				new Stop { ID = 058, Name = "" },
				new Stop { ID = 058, Name = "" },
